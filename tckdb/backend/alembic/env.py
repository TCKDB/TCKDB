...
import tckdb
import tckdb.backend.app.models  # This imports all models via models/__init__.py
...
def render_item(type_, obj, autogen_context):
    ...
    if type_ == "type" and isinstance(obj, MsgpackExt):
        autogen_context.imports.add("from tckdb.backend.app.models.common import MsgpackExt")
        return "MsgpackExt()"
    return False
