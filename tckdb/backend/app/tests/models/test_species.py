...
from tckdb.backend.app.models.species import NonPhysicalSpecies, Species
    ...
    assert species_1.heat_capacity_model == {'model': 'NASA',
                                             ...
                                             'coefficients': {'low': [4.13878818E+00,
                                                              ...
                                                              'high': [2.36095410E+00,
                                                                       ...
                                                                       1.04457152E+01],
                                                              'T int': 1041.96}}
    assert species_1.en_corr_id == 33
...
def test_non_physical_species_model():
    ...
    assert str(np_species_1) == '<NonPhysicalSpecies(id=None, label=formaldehyde, smiles=C=O)>'
