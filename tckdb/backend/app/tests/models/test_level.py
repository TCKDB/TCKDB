...
def test_level_model():
    ...
    level2 = Level(method='wB97xd', basis='def2TZVP', solvation_method='PCM', solvent='water', grid='UltraFine')
    ...
    assert repr(level2) == "<Level(id=None, method='wB97xd', basis='def2TZVP', grid='UltraFine', " \
    ...
    assert repr(level3) == "<Level(id=None, method='B3LYP', basis='6-31G(d,p)', dispersion='gd3bj')>"
    assert str(level3) == "B3LYP/6-31G(d,p) gd3bj"

    level4 = Level(method='DLPNO-CCSD(T)-F12',
                   basis='cc-pVTZ-F12',
    ...
    assert level4.solvation_description == 'APFD/6-311+G(2d,p) SMD water ' \
                                           'e_elect = e_original + sp_e_sol_corrected - sp_e_uncorrected'
    assert repr(level4) == "<Level(id=None, method='DLPNO-CCSD(T)-F12', basis='cc-pVTZ-F12', " \
    ...
    assert str(level4) == "DLPNO-CCSD(T)-F12/cc-pVTZ-F12/aug-cc-pVTZ/C cc-pVTZ-F12-CABS tight-PNO APFD/6-311+G(2d,p) " \
