...
def test_encorr_model():
    ...
    assert str(encorr_1) == "<EnCorr(level_id='1', supported_elements=['H', 'C', 'N', 'O', 'S'])>"
    assert repr(encorr_1) == "<EnCorr(id=None, level_id=1, supported_elements=['H', 'C', 'N', 'O', 'S'], " \
    ...
    assert str(encorr_2) == "<EnCorr(level_id='1', supported_elements=['H', 'C', 'N', 'O', 'S'])>"
    assert repr(encorr_2) == "<EnCorr(id=None, level_id=1, supported_elements=['H', 'C', 'N', 'O', 'S'], " \
