...
def test_bot_model():
    ...
    assert bot_1.git_commit == '7ba4d74c73198c76c70742de8c254e075200a582'
    assert bot_1.git_branch == 'master'
    assert str(bot_1) == "<Bot(name='ARC', version='1.1.0', url='https://github.com/ReactionMechanismGenerator/ARC')>"
    assert repr(bot_1) == "<Bot(id=None, name='ARC', version='1.1.0', " \
                          "url='https://github.com/ReactionMechanismGenerator/ARC', " \
                          "git_commit='7ba4d74c73198c76c70742de8c254e075200a582', " \
                          "git_branch='master')>"
