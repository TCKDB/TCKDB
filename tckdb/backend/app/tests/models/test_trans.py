...
def test_trans_model():
    ...
    assert repr(trans_1) == "<Trans(id=None, model=Single Exponential Down, parameters={'alpha0': (175, 'cm^-1'), " \
                            "'T0': (300, 'K'), 'n': 0.52})>"
    assert str(trans_1) == "<Trans(model='Single Exponential Down', parameters={'alpha0': (175, 'cm^-1'), " \
                           "'T0': (300, 'K'), 'n': 0.52})>"
