...
"""
    ...
    assert spc_20.hessian == [[0.1, 0], [0.5, 0.2]]
...
6 H u0 p0 c0 {3,S}"""
    ...
    # Todo: wait for T3_torsions and T3_2D_tor on TX-E1 for data
    ...
    # Todo test scan paths

    # 15. unconverged_jobs, extras
    spc_21 = SpeciesBase(smiles='C',
                         charge=0,
                         multiplicity=1,
                         coordinates=ch4_xyz,
                         external_symmetry=4,
    ...
    assert spc_21.unconverged_jobs == [{'job type': 'sp',
                                        'issue': 'SCF',
                                        'troubleshooting': 'keyword',
                                        'comment': 'txt',
                                        'path': 'path/to/failed/sp/job.log'}]
    assert spc_21.extras == {'key1': 'val1',
                             'key2': ['v', 'v']}
