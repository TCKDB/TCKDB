...
from tckdb.backend.app.schemas.np_species import NonPhysicalSpeciesBase, NonPhysicalSpeciesCreate, NonPhysicalSpeciesUpdate, NonPhysicalSpeciesRead
...
@router.post("/", response_model=NonPhysicalSpeciesRead, status_code=status.HTTP_201_CREATED)
