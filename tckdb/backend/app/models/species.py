...
class Species(Base):
    ...
    Attributes:
        ...
        # energy corrections
        en_corr_id (int)
            The energy correction key for the :ref:`en_corr table <en_corr>`. Must be specified for non-TS species.

            Note:
                This argument will be facilitated by TCKDB by querying the :ref:`en_corr table <en_corr>`.
    ...
    # energy corrections
    en_corr_id = Column(Integer, ForeignKey('en_corr.id'), nullable=False, unique=False)
