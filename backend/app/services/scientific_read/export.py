...
class SelectedThermo:
    ...
    def to_dict(self) -> dict:
        d: dict = {
            ...
            "phase": self.thermo.phase.value if self.thermo.phase is not None else None,
            "reference_pressure_bar": self.thermo.reference_pressure_bar,
            "enthalpy_formation_0k_kj_mol": self.thermo.enthalpy_formation_0k_kj_mol,
            "enthalpy_formation_0k_uncertainty_kj_mol": self.thermo.enthalpy_formation_0k_uncertainty_kj_mol,
            "h298_uncertainty_kj_mol": self.thermo.h298_uncertainty_kj_mol,
            "s298_uncertainty_j_mol_k": self.thermo.s298_uncertainty_j_mol_k,
